...
document.getElementById("account-step").remove();document.getElementById("loader").style.display='block';setTimeout(function(){document.getElementById("loader").remove();document.getElementById("steps_progress").src="img/progress_5.png";document.getElementById("final-step").style.display='block';},7000);}
...
var questions=[new Question("هل تلعب ببجي موبايل يوميا ؟",["نعم","لا"]),new Question("ما هو مستواك في اللعبة ؟",["أكثر من 50","أقل من 50"]),new Question("اختر كمية الشدات التي تريد شحنها ؟",["أقل من 600 شدة","1500 شدة","3000 شدة","أكثر من 5000 شدة"])];function Quiz(questions){this.questions=questions;this.questionIndex=0;}
